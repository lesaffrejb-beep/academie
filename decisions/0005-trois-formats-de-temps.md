...
|---|---|---|---|
| **Séance** | 8 à 20 min | révisions dues (FSRS, plafond de reprise), 1 à 2 nouveautés, clôture. S'arrêter tôt reste honorable | téléphone d'abord |
...
- Le journal porte le format de chaque révision (`mode`) pour mesurer
