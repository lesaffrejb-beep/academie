...
> **Ce document est un sous-espace du design system du front ERP**, qui fait
> foi au-dessus de lui : [`../DESIGN-SYSTEM.md`](../DESIGN-SYSTEM.md)
> ([ADR 01/09/2026](../../meta/adr/2026-09-01-deux-design-systems.md)).
> L'Académie est une peau dédiée, déclarée, pas un système concurrent.

---

## 1. Les 5 Piliers Architecturaux de l'Académie

L'adaptateur ERP de l'Académie s'articule autour de 5 piliers rigoureux, fidèles au [blueprint du dépôt autonome](https://github.com/lesaffrejb-beep/academie/blob/main/BLUEPRINT.md) :
